...
if supports_scc; then
  ...
  kubectl delete -f ../../pre-install/clusterAdministration/merc-location-svc-scc.yaml
fi

if supports_psp; then
    echo "Removing the PSP and ClusterRole..."
    kubectl delete -f ../../pre-install/clusterAdministration/merc-location-svc-psp.yaml
    kubectl delete -f ../../pre-install/clusterAdministration/merc-location-svc-cr.yaml
fi