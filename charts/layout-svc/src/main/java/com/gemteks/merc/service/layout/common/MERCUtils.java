package com.gemteks.merc.service.layout.common;
...
import com.gemteks.merc.service.layout.repo.mysql.ApiLoginHistoryRepository;
import com.gemteks.merc.service.layout.repo.redis.RedisRepository;
...
public class MERCUtils {
    ...
    public ActionInfo checkValidToken(String userToken) throws MercException {
        ...
        List<ApiLoginHistory> loginHistories =  apiLoginHistoryRepo.findLonginToken(userToken);
