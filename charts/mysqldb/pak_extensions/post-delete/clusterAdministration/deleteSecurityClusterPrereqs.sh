...
if supports_scc; then
  ...
  kubectl delete -f ../../pre-install/clusterAdministration/merc-mysqldb-scc.yaml
fi

if supports_psp; then
    echo "Removing the PSP and ClusterRole..."
    kubectl delete -f ../../pre-install/clusterAdministration/merc-mysqldb-psp.yaml
    kubectl delete -f ../../pre-install/clusterAdministration/merc-mysqldb-cr.yaml
fi