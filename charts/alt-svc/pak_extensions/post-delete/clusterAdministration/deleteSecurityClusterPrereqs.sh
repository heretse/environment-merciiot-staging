...
if supports_scc; then
  ...
  kubectl delete -f ../../pre-install/clusterAdministration/merc-alt-svc-scc.yaml
fi

if supports_psp; then
    echo "Removing the PSP and ClusterRole..."
    kubectl delete -f ../../pre-install/clusterAdministration/merc-alt-svc-psp.yaml
    kubectl delete -f ../../pre-install/clusterAdministration/merc-alt-svc-cr.yaml
fi