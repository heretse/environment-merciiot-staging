...
if supports_scc; then
  ...
  kubectl delete -f ../../pre-install/clusterAdministration/merc-mongodb-scc.yaml
fi

if supports_psp; then
    echo "Removing the PSP and ClusterRole..."
    kubectl delete -f ../../pre-install/clusterAdministration/merc-mongodb-psp.yaml
    kubectl delete -f ../../pre-install/clusterAdministration/merc-mongodb-cr.yaml
fi